...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        ...
        if (window.initDroneControl) window.initDroneControl();
...
function initNavigation() {
    ...
    const panels = {
        ...
        reports: document.getElementById('reports-panel'),
        system: document.getElementById('system-panel'),
        control: document.getElementById('drone-control-panel'),
        gcs: document.getElementById('gcs-panel'),
...
function handleViewSwitch(view, titleEl, grid, panels) {
    ...
    if (view === 'Dashboard') {
        ...
        if (view === 'Drones') {
            ...
            if (view === 'Ground Control') {
                titleEl.textContent = 'Mission Planner - GCS';
                togglePanels(panels, 'gcs');

                // Explicit Init Check
                if (window.GroundControlObj) {
                    window.GroundControlObj.init('gcs-panel');
                } else {
                    alert("Error: GCS Module not loaded.");
                }
            }
